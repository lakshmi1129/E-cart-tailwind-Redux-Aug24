    ...
    <div style={{paddingTop:'100px'}} className='container px-4 mx-auto'>
      {
        ...
        <div className='flex justify-center items-center my-5 text-lg'>
          <img width={'80px'} height={'80px'} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKRrAQ4k9MEwAZpr_LmlY6jvkV1IUk7gIq7Ls3lKVxD3so8O2taw9buQQgQRD1HkDAOak&usqp=CAU" alt="" />
          Loading....
        </div>
        :
        <>
